...
CREATE TABLE IF NOT EXISTS  chat.message (id SERIAL PRIMARY KEY, author INTEGER REFERENCES chat.users(id) NOT NULL, chatroom INTEGER REFERENCES chat.rooms(id) NOT NULL, text TEXT NOT NULL, time TIMESTAMP);